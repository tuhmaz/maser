...
export default function AdminLoginPage() {
  ...
  return (
    <main dir="ltr" className="flex min-h-screen items-center justify-center bg-slate-950 py-10">
      <section dir="rtl" className="mx-5 w-[calc(100vw-2.5rem)] max-w-md rounded-md border border-white/10 bg-white p-6 shadow-2xl shadow-black/30 sm:p-8">
